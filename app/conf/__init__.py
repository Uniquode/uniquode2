...
CORE_CONTEXT_PROCESSORS = [
    'core.context_processors.fontawesome',
    'core.context_processors.page_admin_url',
]
...
CONTEXT_PROCESSORS = DJANGO_CONTEXT_PROCESSORS + CORE_CONTEXT_PROCESSORS
...
AUTHENTICATION_BACKENDS = [
    'components.auth.EmailOrUsernameAuthBackend',
]
...
MEDIA_ROOT = str(DJANGO_ROOT / 'media')
